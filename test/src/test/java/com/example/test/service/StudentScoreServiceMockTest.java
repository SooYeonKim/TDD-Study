...
import com.example.test.repository.StudentFailRepository;
import com.example.test.repository.StudentPassRepository;
...
public class StudentScoreServiceMockTest {
  ...
  public void firstSaveScoreMockTest() {
    ...
    studentScoreService.saveScore(
        givenStudentName, givenExam, givenKorScore, givenEnglishCore, givenMathScore);
  }
